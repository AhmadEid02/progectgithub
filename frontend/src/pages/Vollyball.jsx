...
const teams = ["../assets/team/volleyballTeam1.jpeg", "../assets/team/volleyballTeam1.jpeg",]
...
const Vollyball = () => {
  ...
  const navigateTo = () => {
    navigate("/", { state: { sport: "Volleyball" } });
  }
  ...
  const fetchMatchesData = async () => {
    try {
      const apiUrl = `http://localhost:4000/matches/Volleyball`
  ...
  const fetchNewsData = async () => {
    try {
      const apiUrl = `http://localhost:4000/news/Volleyball`
      const response = await axios.get(`${apiUrl}`);
    ...
    <div>
      ...
      <div className='hero'>
        <div className='welcome'>
          <h2>Welcome to <span className='secCol'>Volleyball</span></h2>
      ...
      <div className="photo-gallery">
        ...
        <img src="../assets/Volleyballfield2.jpg" alt="" />
      </div>
      <div className='gallery-title'>
