...
const Payment = () => {
  ...
  const sum=parseFloat(fieldData.pricePerHour) + (fieldData.referee.refereeCost ? parseFloat(fieldData.referee.refereeCost) : 0) +
        ...
        <div className="deatails">
          ...
          <div className="course">
            <div className="course-row">
              ...
              <span className="">${fieldData.pricePerHour}</span>
            </div>
            <span>1 hour book</span>
          </div>
          {
          ...
          <Button variant="contained" sx={{ alignSelf: 'flex-end',left:'840px',margin:1 }} onClick={handleCheckout}>BOOK at ${sum}</Button>
