...
const teams = ["../assets/team/basketballTeam1.jpeg", "../assets/team/basketballTeam2.jpeg", "../assets/team/basketballTeam3.jpeg"]
...
const Basketball = () => {
  ...
  const navigateTo = () => {
    navigate("/", { state: { sport: "Basketball" } });
  }
  ...
  const fetchNewsData = async () => {
    try {
      const apiUrl = `http://localhost:4000/news/Basketball`
      const response = await axios.get(`${apiUrl}`);
    ...
    <div>
      ...
      <div className='hero'>
        <div className='welcome'>
          <h2>Welcome to <span className='secCol'>Basketball</span></h2>
        ...
        <div className='heroImage'>
          <img src="../assets/basketballVector-removebg.png" alt="" />
        </div>
      </div>
