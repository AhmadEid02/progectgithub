...
const AdminFieldCreate = () => {
    ...
    const [mainImage, setMainImage] = useState(null); // New state for main image file
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await axios.post(`${apiUrl}/api/fields/`, fieldData);
            navigate(-1);
        } catch (error) {
                    ...
                    <div className="admin-image-container-edit">
                        {   mainImage&&
                            <div className="image-wrapper" >
                                ...
                                <img src={`../../../assets/fields/${mainImage}`} alt="" />
                            </div>
                        }
